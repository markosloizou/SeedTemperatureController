...
# 1 "mcc_generated_files/../rotaryEncoderDriver.h" 1
...
# 1 "mcc_generated_files/../global_defines.h" 1
# 114 "mcc_generated_files/../global_defines.h"
typedef enum{SOIL , INTERNAL, PLATE, AMBIENT} sensor;
typedef enum{READ, SET, OFF} reading_state;
# 54 "mcc_generated_files/tmr3.c" 2
...
void TMR3_DefaultInterruptHandler(void){
    ...
    if(switchPreviousStableState != ((PORTD & (1 << 6)) >> 6) )
    {
        SwitchCount++;
        if(SwitchCount == 50)
        {
            ...
            switchPreviousStableState = ((PORTD & (1 << 6)) >> 6);
        }
    }

    currentA1 = (PORTD & (1 << 4)) >> 4;
    currentC1 = (PORTD & (1 << 5)) >> 5;
