...
# 1 "./segmentDisplayDriver.h" 1
# 42 "./segmentDisplayDriver.h"
...
# 87 "main.c"
    ...
    ambient_temp = readTemperatureSensor(000);
    plate_temp = readTemperatureSensor(010);
    internal_temp = readTemperatureSensor(001);
    soil_temp = readTemperatureSensor(011);
